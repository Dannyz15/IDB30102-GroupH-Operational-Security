...
## 2. Summary of Methods / Algorithms Identified

| Method Family | Example Studies | Strength | Weakness |
|---|---|---|---|
| Compliance/standards-based (NIST, ISO/IEC 27k, OCTAVE) | Perdana et al. (2022); Zahran et al. (2026); Parkpean & Nirapai (2025) | Auditable, recognised by regulators, widely adopted | Generic, resource-intensive, does not capture human factors |
| Probabilistic / fuzzy modelling | Yang et al. (2025); Noor et al. (2025); Bissadu et al. (2024) | Models uncertainty better than checklists; improves estimation accuracy | Requires specialist input; not yet benchmarked across studies |
| Threat modelling (STRIDE, IEC 62443) | Tatavarthi & Panigrahi (2023); Kanamaru et al. (2023) | Structured, maps directly to attack surfaces; fits Group H's suggested methodology | Largely conceptual; rarely validated empirically |
| Machine learning / classifiers | Malik & Tosh (2024); El-Hajj & Mirza (2024) | High technical accuracy (e.g. 98% phishing-URL classification) | Bench-tested only; not evaluated on how output is used by analysts |
| LLM-assisted assessment | Iyenghar et al. (2026); Svensson et al. (2026); Mohsin et al. (2025) | Scalable, can process unstructured input, cuts assessment time | Reliability drops on unstructured real-world input; human-in-the-loop still required |
| Survey / self-report instruments | Shah et al. (2023); Alharbi (2023); Sharifi et al. (2024) | Captures perception, culture and awareness directly | Subjective, not linked to technical risk measures, limited generalisability |

## 3. Relevant Datasets and Data Sources Identified
...
## 4. Evaluation Metrics Identified from Previous Research
...
## 6. References Supporting the Proposed Methodology
